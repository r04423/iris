...
import { IrisInvalidState, registerObserverCallback, unregisterObserverCallback } from "iris-ecs";
...
export function useWorld(): World {
  ...
  if (world === null) {
    throw new IrisInvalidState({ message: "useWorld must be used within a WorldProvider" });
  }
